...
init_item_data(void) {
    ...
    register_item_type(ITEM_CHERRY_PLANKS, "minecraft:cherry_planks");
    ...
    register_item_type(ITEM_BAMBOO_PLANKS, "minecraft:bamboo_planks");
    ...
    register_item_type(ITEM_BAMBOO_MOSAIC, "minecraft:bamboo_mosaic");
    ...
    register_item_type(ITEM_CHERRY_SAPLING, "minecraft:cherry_sapling");
    ...
    register_item_type(ITEM_CHERRY_LOG, "minecraft:cherry_log");
    ...
    register_item_type(ITEM_BAMBOO_BLOCK, "minecraft:bamboo_block");
    ...
    register_item_type(ITEM_STRIPPED_CHERRY_LOG, "minecraft:stripped_cherry_log");
    ...
    register_item_type(ITEM_STRIPPED_CHERRY_WOOD, "minecraft:stripped_cherry_wood");
    ...
    register_item_type(ITEM_STRIPPED_BAMBOO_BLOCK, "minecraft:stripped_bamboo_block");
    ...
    register_item_type(ITEM_CHERRY_WOOD, "minecraft:cherry_wood");
    ...
    register_item_type(ITEM_CHERRY_LEAVES, "minecraft:cherry_leaves");
    ...
    register_item_type(ITEM_PINK_PETALS, "minecraft:pink_petals");
    ...
    register_item_type(ITEM_CHERRY_SLAB, "minecraft:cherry_slab");
    ...
    register_item_type(ITEM_BAMBOO_SLAB, "minecraft:bamboo_slab");
    register_item_type(ITEM_BAMBOO_MOSAIC_SLAB, "minecraft:bamboo_mosaic_slab");
    ...
    register_item_type(ITEM_CHISELED_BOOKSHELF, "minecraft:chiseled_bookshelf");
    register_item_type(ITEM_DECORATED_POT, "minecraft:decorated_pot");
    ...
    register_item_type(ITEM_CHERRY_FENCE, "minecraft:cherry_fence");
    ...
    register_item_type(ITEM_BAMBOO_FENCE, "minecraft:bamboo_fence");
    ...
    register_item_type(ITEM_CHERRY_STAIRS, "minecraft:cherry_stairs");
    ...
    register_item_type(ITEM_BAMBOO_STAIRS, "minecraft:bamboo_stairs");
    register_item_type(ITEM_BAMBOO_MOSAIC_STAIRS, "minecraft:bamboo_mosaic_stairs");
    ...
    register_item_type(ITEM_CHERRY_BUTTON, "minecraft:cherry_button");
    ...
    register_item_type(ITEM_BAMBOO_BUTTON, "minecraft:bamboo_button");
    ...
    register_item_type(ITEM_CHERRY_PRESSURE_PLATE, "minecraft:cherry_pressure_plate");
    ...
    register_item_type(ITEM_BAMBOO_PRESSURE_PLATE, "minecraft:bamboo_pressure_plate");
    ...
    register_item_type(ITEM_CHERRY_DOOR, "minecraft:cherry_door");
    ...
    register_item_type(ITEM_CHERRY_TRAPDOOR, "minecraft:cherry_trapdoor");
    ...
    register_item_type(ITEM_CHERRY_FENCE_GATE, "minecraft:cherry_fence_gate");
    ...
    register_item_type(ITEM_BAMBOO_FENCE_GATE, "minecraft:bamboo_fence_gate");
    ...
    register_item_type(ITEM_CHERRY_BOAT, "minecraft:cherry_boat");
    register_item_type(ITEM_CHERRY_CHEST_BOAT, "minecraft:cherry_chest_boat");
    ...
    register_item_type(ITEM_BAMBOO_RAFT, "minecraft:bamboo_raft");
    register_item_type(ITEM_BAMBOO_CHEST_RAFT, "minecraft:bamboo_chest_raft");
    ...
    register_item_type(ITEM_CHERRY_SIGN, "minecraft:cherry_sign");
    ...
    register_item_type(ITEM_BAMBOO_SIGN, "minecraft:bamboo_sign");
    register_item_type(ITEM_CRIMSON_SIGN, "minecraft:crimson_sign");
    register_item_type(ITEM_WARPED_SIGN, "minecraft:warped_sign");
    register_item_type(ITEM_OAK_HANGING_SIGN, "minecraft:oak_hanging_sign");
    register_item_type(ITEM_SPRUCE_HANGING_SIGN, "minecraft:spruce_hanging_sign");
    register_item_type(ITEM_BIRCH_HANGING_SIGN, "minecraft:birch_hanging_sign");
    register_item_type(ITEM_JUNGLE_HANGING_SIGN, "minecraft:jungle_hanging_sign");
    register_item_type(ITEM_ACACIA_HANGING_SIGN, "minecraft:acacia_hanging_sign");
    register_item_type(ITEM_CHERRY_HANGING_SIGN, "minecraft:cherry_hanging_sign");
    register_item_type(ITEM_DARK_OAK_HANGING_SIGN, "minecraft:dark_oak_hanging_sign");
    register_item_type(ITEM_MANGROVE_HANGING_SIGN, "minecraft:mangrove_hanging_sign");
    register_item_type(ITEM_BAMBOO_HANGING_SIGN, "minecraft:bamboo_hanging_sign");
    register_item_type(ITEM_CRIMSON_HANGING_SIGN, "minecraft:crimson_hanging_sign");
    register_item_type(ITEM_WARPED_HANGING_SIGN, "minecraft:warped_hanging_sign");
    ...
    register_item_type(ITEM_ENDER_DRAGON_SPAWN_EGG, "minecraft:ender_dragon_spawn_egg");
    ...
    register_item_type(ITEM_IRON_GOLEM_SPAWN_EGG, "minecraft:iron_golem_spawn_egg");
    ...
    register_item_type(ITEM_SNIFFER_SPAWN_EGG, "minecraft:sniffer_spawn_egg");
    register_item_type(ITEM_SNOW_GOLEM_SPAWN_EGG, "minecraft:snow_golem_spawn_egg");
    ...
    register_item_type(ITEM_WITHER_SPAWN_EGG, "minecraft:wither_spawn_egg");
    ...
    register_item_type(ITEM_PIGLIN_HEAD, "minecraft:piglin_head");
